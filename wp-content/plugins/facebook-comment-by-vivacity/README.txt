...
Contributors: vivacityinfotech.jaipur, Alex Moss, Peadig
...
* You can control accessibility of comment box on pages.
...
This plugin is basically a fork of:  https://wordpress.org/plugins/facebook-comments-plugin/.
...
== Changelog ==
= 1.4.1 =
* Worked on improve security Methods.
* Improve load time. 
